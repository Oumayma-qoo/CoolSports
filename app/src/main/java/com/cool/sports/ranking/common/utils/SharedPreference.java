...
public class SharedPreference
	{
        ...
        @Nullable
        public static final String SHOW_PROMPT="show_pormpt";
		@Nullable
		public static final String PROMPT_URL="prompt_url";
		@Nullable
		...
		@Nullable
		public static final String PROMPT_SHOW_TIME="promopt_shown_time";
        @NotNull
        public static final String NO_DATA_FOUND="NOT_FOUND";
		...
		public void saveIntToPreferences(String key, int value, Context context)
			{
				if (sharedPreferences == null)
					{
						sharedPreferences = context.getSharedPreferences(context.getString(com.cool.sports.ranking.R.string.app_pref_name), 0);
					}
